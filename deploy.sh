docker build -t rickywraith/stock-predict-dm:latest -t rickywraith/stock-predict-dm:$SHA -f ./Data_Model_Dockerfile .
docker build -t rickywraith/stock-predict-s3:latest -t rickywraith/stock-predict-s3:$SHA -f ./S3_Dockerfile .
